...
public class animal_acuatico extends animal {
    ...
    super(nombre, especie, raza, color, sexo, edad, peso, altura, tipo, habitat, alimentacion, reproduccion, cuidados,
        enfermedades, vacunas, id, salud, comportamiento); //super invoca al constructor de animal
    this.aletas = aletas;
    this.branquias = branquias;
    this.escamas = escamas;
    this.tipo_agua = tipo_agua;
}
// is se usa para booleans para ver si tiene o no, (si no es boolean uso el get)
